      ...
      var HttpService = /*#__PURE__*/function () {
        ...
        _createClass(HttpService, [{
          ...
          value: function getCards() {
            return this.http.get('assets/api/kard.json');
          }
        }, {
          key: "getNews",
          value: function getNews() {
            return this.http.get('assets/api/news.json');
          }
        }, {
          key: "getZaim",
          value: function getZaim() {
            return this.http.get('assets/api/zaim.json');
          }
        }, {
          key: "getPrivacyPolicy",
          value: function getPrivacyPolicy() {
            return this.http.get('assets/api/politika-confidens.json');
          }
        }]);
